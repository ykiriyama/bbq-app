...
texts = {
    "ja": {
        ...
        "people": "1️⃣ 何人分のサービスをご希望ですか？",
        "shopping": "2️⃣ ショッピング〜お届けサービスをご希望ですか？",
        "shopping_options": ["希望しない（シェフ渡遣のみ）", "食材のみ", "食材＋ドリンク"],
        "date": "🗓 希望日を選択してください",
        "time": "🕒 開始希望時間を選択してください",
        "result": "📄 お見積もり結果",
        "total": "合計金額：",
        "note": "（※食材費は含まれていません）",
    ...
    "en": {
        ...
        "shopping_options": ["No (Chef hire only)", "Food only", "Food + Drinks"],
        "date": "🗓 Select your preferred BBQ date",
        "time": "🕒 Select preferred start time",
...
date = st.date_input(t["date"], min_value=datetime.today())
time_input = st.time_input(t["time"], value=time(12, 0))
